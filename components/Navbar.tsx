    ...
    <div
      ...
      <div
        ...
        <div
          className={
            nav
              ? ' fixed left-0 top-0 w-[75%] sm:w-[70%] md:w-[45%] h-screen bg-[#ecf0f3] p-8 ease-in duration-500'
          ...
          <div>
            <div className='flex w-full items-center justify-between '>
              ...
              <div
                onClick={handleNav}
                className='rounded-tr-sm bg-gray-300 text-gray-800 font-bold  p-3 shadow-md cursor-pointer'>
                <AiOutlineClose
